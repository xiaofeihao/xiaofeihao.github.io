...
> 
> SwipeRefreshLayout 也可放在 CoordinatorLayout 内共同处理滑动冲突，有兴趣可以尝试。## SwipeRefreshLayout 源码分析
> 本文基于 v4 版本 `23.2.0`
...
> 经过以上几个步骤，SwipeRefreshLayout 创建了子视图，确定他们的大小、位置，现在所有视图可以显示在界面了。### 处理与子视图的滚动交互
